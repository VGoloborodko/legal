...
export default function Chart({ className, size = 24, width = size, height = size, fill = 'none', stroke = 'currentColor', ...props }: BaseSvgIconProps) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M15.5 10.5L12.5 13.5L10.5 11.5L7.5 14.5" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      />
      <circle cx="18.5" cy="5.5" r="2" stroke={stroke} />
    </svg>
  );
}
