...
export default function PhoneOff({ className, size = 24, width = size, height = size, fill = 'currentColor', stroke = 'currentColor', ...props }: BaseSvgIconProps) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        stroke={stroke}
      />
      <rect x="16.8022" y="7.42029" width="1" height="15.4024" transform="rotate(51.8854 16.8022 7.42029)" fill={fill} />
    </svg>
  );
}
